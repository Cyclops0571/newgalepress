...
class language
{
    ...
    private function load()
    {
        ...
        if (file_exists($this->user_folder . $cookieLang . '_aus.lang.php')) {
            include($this->user_folder . $cookieLang . '_aus.lang.php');
        } else if ($this->system_folder . $cookieLang . '_aus.lang.php') {
            include($this->system_folder . $cookieLang . '_aus.lang.php');
        } else {
