...
class lang {
	...
	function __construct() {
		...
		$language_array['month']												= 'month';
		$language_array['day']													= 'day';
		$language_array['hour']													= 'hour';
		$language_array['minute']												= 'minute';
		$language_array['Transfer to Department']								= 'Transfer to Department';
		$language_array['An email will be sent to this department.']			= 'An email will be sent to this department.';
		$language_array['Assign User']											= 'Assign User';
		$language_array['An email will be sent to this person.']				= 'An email will be sent to this person.';
		$language_array['Last Replier']											= 'Last Replier';
		$language_array['Change State']											= 'Change State';
		$language_array['Email notifications are not sent when editing a ticket from this page.']	= 'Email notifications are not sent when editing a ticket from this page.';
		$language_array['Allow Login']											= 'Allow Login';
		$language_array['Account Added']										= 'Account Added';
		$language_array['Assigned Tickets']										= 'Assigned Tickets';
		$language_array['Email Address (recommended)']							= 'Email Address (recommended)';
		$language_array['Phone Number (optional)']								= 'Phone Number (optional)';
		...
		$language_array['s']													= 's';
		$language_array['Show Filter']											= 'Show Filter';
