    ...
    <div class="col-md-12">
        <div class="block block-drop-shadow">
            ...
            <div class="content controls">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-8">
                        <select style="width: 100%;" tabindex="-1" id="ApplicationID" name="ApplicationID"
                            ...
                            <option value="<?php echo $app->ApplicationID; ?>" <?php echo $ApplicationID == $app->ApplicationID ? 'selected="selected"' : ''; ?>>
                                <?php echo $app->Name; ?>
                            </option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="col-md-1"><a class="tipr" title="<?php echo __('common.menu_caption_applications'); ?>"><span
                ...
                <div class="form-row">
                    <div class="col-md-3"><?php echo __('common.clients_password'); ?><?php echo $ClientID == 0 ? ' <span class="error">*</span>' : ''; ?></div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-1"><a class="tipr" title="<?php echo __('common.clients_firstname'); ?>"><span
                                    class="icon-info-sign"></span></a></div>
                </div>
                <div class="form-row">
