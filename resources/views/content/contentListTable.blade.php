      ...
      @forelse($rows as $row)
        <tr id="contentIDSet_{{$row->ContentID}}" class="{{ Common::htmlOddEven($page) }}" {{Common::getClass($row)}} >
          @if((int)Auth::user()->UserTypeID == eUserTypes::Manager)
            <td>
              <a href="{{$route.'/'.$row->ContentID}}">{{$row->CustomerName}}</a>
            </td>
            <td>
              <a href="{{$route.'/'.$row->ContentID}}">{{$row->ApplicationName}}</a>
            </td>
            <td>
              <a href="{{$route.'/'.$row->ContentID}}">{{$row->Name}}</a>
            </td>
            <td>
              <a href="{{$route.'/'.$row->ContentID}}">{{$row->Blocked}}</a>
            </td>
            <td>
              <a href="{{$route.'/'.$row->ContentID}}">{{$row->Status}}</a>
            </td>
            <td>
              <a href="{{$route.'/'.$row->ContentID}}">{{$row->ContentID}}</a>
            </td>
          ...
          <span class="icon-resize-vertical list-draggable-icon" @if($row->IsMaster==1)style="margin-left:-5px;"@endif>
            ...
            <td>
              <a href="{{$route.'/'.$row->ContentID}}">{{$row->Detail}}</a>
            </td>
            <td>
              <a href="{{$route.'/'.$row->ContentID}}">{{$row->MonthlyName}}</a>
            </td>
            <td>
              <a href="{{$route.'/'.$row->ContentID}}">{{$row->CategoryName}}</a>
            </td>
            <td>
              <a href="{{$route.'/'.$row->ContentID}}">{{Common::dateRead($row->PublishDate, 'd.m.Y')}}</a>
            </td>
            <td>
              <a href="{{$route.'/'.$row->ContentID}}">{{Common::dateRead($row->UnpublishDate, 'd.m.Y')}}</a>
            </td>
            <td>
              <a href="{{$route.'/'.$row->ContentID}}">{{$row->Blocked}}</a>
            </td>
