<header>
  <div id="topbar">
    <div id="logo">
      <img src="/img/logo.png" alt="Gale Press">
    </div>
  ...
  <div id="pdf-controls">
    <div id="full-screen">
      <a href="#" onclick="toogleFullscreen();"><i class="icon-fullscreen"></i></a>
    </div>
    <div id="thumbs">
      <div class="text dark">
          ...
          <ul class="slideshow-slides js-slideshow-slides">
            @foreach($pages as $page)
              <li class="each-slide js-slideshow-slide">
                <a href="#" class="img-tooltip" pageno="{{ $page->No }}">
                  <img src="/{{ $page->FilePath }}/{{ $page->FileName }}" alt="{{ $page->No }}" title="{{ $page->No }}">
                  <span>{{ $page->No }}</span></a>
              </li>
            @endforeach
          </ul>
