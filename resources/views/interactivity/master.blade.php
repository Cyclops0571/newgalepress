...
@section('body-content')
    ...
    <div id="wrapper">
        ...
        <div id="modal-editor" class="editor hide">
            ...
            <div class="action">
                <input type="button" value="{{ __('interactivity.cancel') }}" class="btn btn-cancel" onclick="cInteractivity.clickCancel();">
                <input type="button" value="{{ __('interactivity.ok') }}" class="btn btn-secondary" onclick="cInteractivity.clickOk();">
            </div>
        </div>
        ...
        <div class="transfer-modal hide">
            ...
            <div>
                <p class="all">
                    <strong>{{ __('interactivity.page') }} <em></em></strong> <span>{{ __('interactivity.transfer_description') }}</span>
                </p>
                <p class="one">
                    <strong>{{ __('interactivity.page') }} <em></em></strong> <span text="{{ __('interactivity.transfer_description2') }}"></span>
                </p>
                <br>
