...
<table background="http://www.galepress.com/img/mail-templates/aktivasyon/header-bg.png"
                            ...
                            <tr>
                                <td align="center" style="line-height: 0px;">
                                    <img style="display:block; line-height:0px; font-size:0px; border:0px;"
                                         src="http://www.galepress.com/img/mail-templates/aktivasyon/logo.png"
                                         width="200" alt="img"/>
                                </td>
                            </tr>
                            <!--end Header Logo-->
                ...
                <tr>
                    <td align="center">
                        <table align="center" class="table-inner" width="500" border="0" cellspacing="0"
                            ...
                            <tr>
                                <td align="center">
                                    <table bgcolor="#1f86c0" style="border-radius:5px;" width="50" border="0"
                            ...
                            <tr>
                                <td align="center">
                                    <table class="table-full" bgcolor="#1f86c0" style="border-radius:4px;" border="0"
