...
.preference a { color: #1f86c0 !important;text-decoration: underline !important; }
...
<body>
	...
	<table background="http://www.galepress.com/img/mail-templates/hosgeldiniz/header-bg.png" style="background-size:100% auto; background-position:top; background-repeat:repeat-x" width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#1f86c0">
		<tr>
		...
		<tr>
			<td align="center">
				...
				<table bgcolor="#FFFFFF" style="border-radius:6px;" width="600" border="0" align="center" cellpadding="0" cellspacing="0" class="table-inner">
					<tr>
						<td height="40"></td>
					</tr>
					<tr>
							...
							<table class="table-inner" align="center" width="420" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									<td align="center" style="line-height: 0px;">
										<img style="display:block; line-height:0px; font-size:0px; border:0px;" src="http://www.galepress.com/img/mail-templates/hosgeldiniz/logo.png" width="200" alt="img"/>
									</td>
								</tr>
								<!--end Header Logo-->
								...
								<!--slogan-->
								<tr>
									<td align="center" style="font-family: Verdana, Arial, sans-serif; color:#a7aeb3; font-size:12px;line-height: 28px;">Digital Publishing Platform</td>
								</tr>
								<!--end slogan-->
							</table>
						</td>
