            ...
            <div class="content controls" style="overflow:visible">
                ...
                <div class="form-row">
                    <div class="col-md-3"><label class="label-grey"
                                                 for="Name">{{ __('common.contents_name') }}</label><span class="error">*</span>
                    </div>
                    <div class="col-md-8">
                        <input type="text" name="Name" id="Name" class="form-control textbox required"
                               value="{{ $Name }}"/>
                    </div>
                    <div class="col-md-1"><a class="tipr" title="{{ __('common.contents_tooltip_name') }}"><span
                                    class="icon-info-sign"></span></a></div>
                </div>
                <div class="form-row">
                    <div class="col-md-3"><label class="label-grey"
                                                 for="Detail">{{ __('common.contents_detail') }}</label></div>
                    <div class="col-md-8">
                        <textarea class="form-control" name="Detail" id="Detail" rows="2"
                                  cols="15">{{ $Detail }}</textarea>
                    </div>
                ...
                <div class="form-row">
                    <div class="col-md-3">
                        ...
                        <a href="javascript:void(0);" class="widget-icon widget-icon-circle"
                           onclick="cContent.showCategoryList();" data-toggle="modal"><span class="icon-pencil"></span></a>
                    </div>
                    <div class="col-md-8">
                        <select id="CategoryID" name="chkCategoryID[]" multiple="multiple" class="chosen-container"
                            ...
                            $cnt = 0;
                            if ($ContentID > 0) {
                                $cnt = ContentCategory::where('ContentID', '=', $ContentID)->where('CategoryID', '=', '0')->count();
                            }
                            ?>
                            @if($cnt>0)
                                <option value=""
                                        selected="selected">{{ __('common.contents_category_list_general') }}</option>
                            @else
                            ...
                            if ($ContentID > 0) {
                                $cnt = ContentCategory::where('ContentID', '=', $ContentID)->where('CategoryID', '=', $category->CategoryID)->count();
                            }
                            ?>
                ...
                <div class="form-row">
                    <div class="col-md-3"><label class="label-grey"
                                                 for="MonthlyName">{{ __('common.contents_monthlyname') }}</label></div>
                    <div class="col-md-8">
                ...
                <div class="form-row" style="background: none !important;">
                    <div class="col-md-3 "><label class="label-grey"
                                                  for="PublishDate">{{ __('common.contents_publishdate') }}</label>
                    </div>
                    <div class="col-md-8">
                        <div class="input-group">
                    ...
                    <div class="col-md-1"><a class="tipr" title="{{ __('common.contents_tooltip_publishdate') }}"><span
                                    class="icon-info-sign"></span></a></div>
                </div>
                <div class="form-row" style="background: none !important;">
                    <div class="col-md-3 ">
                ...
                @if($ContentFile && $authInteractivity)
                    ...
                    @if(sizeof($contentList)>0)
                        <div class="form-row">
                            ...
                            <div class="col-md-4">
                                <select data-placeholder="{{ __('common.contents_interactivity_target') }}"
                                        style="width: 100%;" tabindex="-1" id="AppContents" name="AppContents"
                            ...
                            <div class="col-md-1"><a class="tipr"
                                                     title="{{ __('common.contents_interactivity_copy_info') }}"><span
                                            class="icon-info-sign"></span></a></div>
                        </div>
                    @endif
                @endif
        ...
        <div class="block">
            <div class="content controls" style="overflow:visible">
                <div class="form-row">
                    ...
                    <div class="col-md-1"><a class="tipr" title="{{ __('common.contents_tooltip_orientation') }}"><span
                                    class="icon-info-sign"></span></a></div>
                </div>
            </div>
        </div>
        <div class="block">
            <div class="content controls" style="overflow:visible">
                <div class="form-row">
                    ...
                    <div class="col-md-1"><a class="tipr" title="{{ __('common.contents_tooltip_ismaster') }}"><span
                                    class="icon-info-sign"></span></a></div>
                </div>
            </div>
        </div>
        ...
        <div class="block {{ ((int)$IsMaster == 1 ? 'disabledFields' : '') }}">
            <div class="content controls" style="overflow:visible">
                <div class="form-row">
                    ...
                    <div class="col-md-1"><a class="tipr" title="{{ __('common.contents_tooltip_isprotected') }}"><span
                                    class="icon-info-sign"></span></a></div>
                </div>
                <div class="form-row">
                    <div class="col-md-3">
                        ...
                        <a href="javascript:void(0);" class="widget-icon widget-icon-circle"
                           onclick="cContent.showPasswordList();" data-toggle="modal"><span
                                    class="icon-group"></span></a>
                    </div>
                    <div class="col-md-8">
                        <input type="password" name="Password" id="Password" class="form-control textbox"
                               value="" {{ ((int)$IsMaster == 1 ? 'disabled="disabled"' : '') }}/>
                    </div>
                    <div class="col-md-1"><a class="tipr" title="{{ __('common.contents_tooltip_password') }}"><span
                                    class="icon-info-sign"></span></a></div>
                </div>
            </div>
        </div>
        ...
        <div class="block">
            <div class="content controls" style="overflow:visible">
                <div class="form-row <?php echo ($ContentID && $IsBuyable) > 0 ? "" : 'disabledFields hide' ?>">
                    ...
                    <div class="col-md-8">
                        <div class="input-group">
                            <input type="text" id="ContentIdentifier" value="<?php echo $Identifier; ?>"
                                   readonly="readonly">
                    ...
                    <div class="col-md-1"><a class="tipr" title="{{ __('common.contents_tooltip_identifier') }}"><span
                                    class="icon-info-sign"></span></a></div>
                </div>
                <div class="form-row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-1"><a class="tipr" title="{{ __('common.contents_tooltip_isbuyable') }}"><span
                                    class="icon-info-sign"></span></a></div>
                </div>
                <div class="form-row disabledFields hide">
                    ...
                    <div class="col-md-1"><a class="tipr" title="{{ __('common.contents_tooltip_currency') }}"><span
                                    class="icon-info-sign"></span></a></div>
                </div>
            </div>
        </div>
        ...
        <div class="block disabledFields hide">
            <div class="content controls" style="overflow:visible">
                <div class="form-row">
                    ...
                    <div class="col-md-1"><a class="tipr" title="{{ __('common.contents_tooltip_autodownload') }}"><span
                                    class="icon-info-sign"></span></a></div>
                </div>
            </div>
        </div>
            ...
            <div class="content controls" style="overflow:visible">
                @if((int)Auth::user()->UserTypeID == eUserTypes::Manager)
                    <div class="form-row">
                        ...
                        <div class="col-md-1"><a class="tipr" title="{{ __('common.contents_tooltip_approval') }}"><span
                                        class="icon-info-sign"></span></a></div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-1"><a class="tipr" title="{{ __('common.contents_tooltip_blocked') }}"><span
                                        class="icon-info-sign"></span></a></div>
                    </div>
                @endif
                <div class="form-row">
                ...
                <div class="cta_container">
                    <div class="modal-footer modal-footer-categoryList">
                        <div class="col-md-5" style="float:right;">
                            <input type="button" value="{{ __('common.contents_category_new') }}"
                                   class="btn my-btn-default" onclick="cContent.addNewCategory();"/>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-footer modal-footer-categoryList">
                        ...
                        <div class="form-row">
                            <div class="col-md-4" style="float:right;">
                                <input type="button" value="{{ __('common.detailpage_save') }}"
                                       class="btn my-btn-success" onclick="cContent.saveCategory();"/>
                            </div>
                            <div class="col-md-4" style="float:right;">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="cta_container">
                    <div class="modal-footer modal-footer-categoryList">
                        <div class="col-md-5" style="float:right;">
                            <input type="button" value="{{ __('common.contents_password_new') }}"
                                   class="btn my-btn-default" onclick="cContent.addNewPassword();"/>
                        </div>
                    </div>
                </div>
                <div class="form_container hidden">
                    ...
                    <div class="modal-footer modal-footer-categoryList">
                        ...
                        <div class="form-row">
                            <div class="col-md-4" style="float:right;">
                                <input type="button" value="{{ __('common.detailpage_save') }}"
                                       class="btn my-btn-success" onclick="cContent.savePassword();"/>
                            </div>
                            <div class="col-md-4" style="float:right;">
