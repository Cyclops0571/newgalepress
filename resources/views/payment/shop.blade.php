...
<html> <!--<![endif]-->
  <head>
    ...
    <!-- Web Fonts  -->
    <link
        href='http://fonts.googleapis.com/css?family=Titillium+Web:400,200,300,200italic,400italic&subset=latin,latin-ext'
    ...
    <div class="body">
      <header id="header">
        <div class="container">
          <h1 class="logo">
            <a href="{{route('home')}}">
              <img alt="Gale Press" data-sticky-width="252" data-sticky-height="82" src="/images/website/logo-dark.png">
            </a>
          </h1>
          <nav>
                          ...
                          <div class="col-md-3">
                            <ul class="sub-menu">
                              <li>
                                ...
                                <span
                                    class="mega-menu-sub-title"><?php echo __('website.distance_sales_contract'); ?></span>
                                <ul class="sub-menu">
                                  <li>
                                    <a href="/website/sozlesme/mesafeli-satis-sozlesmesi.docx?1">
                                      <img src="/website/styles/shop/img/mesafeliSatis.jpg" width="200"/>
                                    </a>
                                  </li>
                                </ul>
                              </li>
                          ...
                          <div class="col-md-3">
                            <ul class="sub-menu">
                              <li>
                                <span class="read"><?php echo __('website.read'); ?></span>
                                <span
                                    class="mega-menu-sub-title"><?php echo __('website.confidentiality_agreement');?></span>
                                <ul class="sub-menu">
                                  <li>
                                    <a href="/website/sozlesme/gizlilik.docx">
                                      <img src="/website/styles/shop/img/gizlilik.jpg" width="200"/>
                                    </a>
                                  </li>
                                </ul>
                              </li>
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-12">
                <ul class="breadcrumb">
                  <li>
                    <a href="/"><?php echo __('website.page_home'); ?></a>
                  </li>
            ...
            <div class="pricing-table">
              ...
              <div class="col-md-offset-4 col-md-3 center">
                <div class="plan most-popular">
                  ...
                  <h3>Standart<span style="line-height: 80px;">&#x20BA;<?php echo $applications[0]->Price ?></span><br/><i
          ...
          <div class="row">
            ...
            <div class="col-md-5">
              <div class="contact-details">
                ...
                <ul class="contact">
                  <li>
                    <p><i class="icon icon-map-marker"></i> <strong>Adres:</strong> Alemdağ Cad. No: 109,
                      Üsküdar / İstanbul / Türkiye
                    </p>
                  </li>
                  <li>
                    <p><i class="icon icon-phone"></i> <strong>Telefon:</strong> +90 (216) 443 13 29</p>
                  </li>
                  <li>
                    <p><i class="icon icon-print"></i> <strong>Fax:</strong> +90 (216) 443 08 27</p>
                  </li>
                  <li>
                    <p><i class="icon icon-envelope"></i> <strong>Email:</strong>
                      <a href="mailto:info@galepress.com">info@galepress.com</a>
                    </p>
                  </li>
                </ul>
              </div>
            ...
            <div class="col-md-2">
              ...
              <div class="social-icons">
                <ul class="social-icons">
                  <li class="facebook">
                    <a href="https://www.facebook.com/pages/Galepress/267455253374597?fref=ts" target="_blank"
                       data-placement="bottom" rel="tooltip" title="Facebook">Facebook
                    </a>
                  </li>
                  <li class="twitter">
                    <a href="https://twitter.com/GalePress" target="_blank" data-placement="bottom" rel="tooltip"
                       title="Twitter">Twitter
                    </a>
                  </li>
                  <li class="linkedin">
                    <a href="https://www.linkedin.com/company/galepress" target="_blank" data-placement="bottom"
                       rel="tooltip" title="Linkedin">Linkedin
                    </a>
                  </li>
                </ul>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <nav id="sub-menu">
                  <ul>
                    <li>
                      <img src="/website/styles/shop/img/visa.png" width="45"/>
                    </li>
                    <li>
                      <img src="/website/styles/shop/img/master.png" width="45"/>
                    </li>
                  </ul>
                </nav>
              </div>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form action="{{route('payment_card_info')}}" method="post" id="userInfos" class="form-horizontal" novalidate>
            {!! csrf_field() !!}
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <div class="col-xs-9">
                  <select id="applicationID" onchange="setUIPrice();" class="form-control required" name="applicationID"
              ...
              <div class="form-group">
                ...
                <div class="col-xs-9">
                  <input class="form-control required" type="checkbox" checked data-toggle="toggle" data-size="normal"
                         id="customerType" name="customerType" data-onstyle="success" data-offstyle="info"
                         data-on="<?php echo __('website.individual');?>" data-off="<?php echo __('website.company');?>"
                         data-width="200">
                </div>
              </div>
              <div class="form-group">
                <label for="email" class="control-label col-xs-3"><?php echo __('website.email_address');?></label>

                <div class="col-xs-9">
                  <input id="email" class="form-control required" maxlength="50" name="email" size="50" type="email"
                         tabindex="1" value="<?php echo $paymentAccount->email; ?>" placeholder="Email" required>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-xs-9">
                  <input id="phone" maxlength="14" name="phone" size="20" type="text" class="form-control required"
                         tabindex="2" value="<?php echo $paymentAccount->phone; ?>" placeholder="Telefon" required>
                </div>
              </div>
              <hr>
              ...
              <div class="form-group">
                ...
                <div class="col-xs-9">
                  <input id="customerTitle" class="form-control required" maxlength="100" name="customerTitle" size="20"
                         type="text" tabindex="6" value="<?php echo $paymentAccount->title; ?>"
                         placeholder="<?php echo __('website.username_company_name');?>" required>
                </div>
              </div>
              <div class="form-group">
                <label for="tc" class="control-label col-xs-3"><?php echo __('website.identification_number');?></label>

                <div class="col-xs-9">
                  <input class="form-control required" id="tc" name="tc" type="text" maxlength="11" tabindex="3"
                         value="<?php echo $paymentAccount->tckn; ?>"
              ...
              <div class="form-group hide">
                ...
                <div class="col-xs-9">
                  <input id="taxOffice" class="form-control required" maxlength="100" name="taxOffice" size="20"
                         type="text" tabindex="7" value="<?php echo $paymentAccount->vergi_dairesi; ?>"
                         placeholder="<?php echo __('website.tax_administration');?>" required>
                </div>
              </div>
              <div class="form-group hide">
                ...
                <div class="col-xs-9">
                  <input id="taxNo" class="form-control required" maxlength="100" name="taxNo" size="20" type="text"
                         tabindex="8" value="<?php echo $paymentAccount->vergi_no; ?>"
              ...
              <div class="form-group">
                ...
                <div class="col-xs-9">
                  <input id="country" class="form-control required" maxlength="25" name="country" size="20" type="text"
                         tabindex="4" value="Türkiye" placeholder="<?php echo __('website.country');?>" required
                         disabled>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-xs-9">
                  <select id="city" class="form-control required" name="city" tabindex="6"
                    ...
                    <option selected="selected" disabled="disabled"><?php echo __('website.select_city');?></option>
                    @foreach($city as $c)
                      <option
                          value="{{$c->CityID}}" <?php echo $c->CityID == $paymentAccount->CityID ? 'selected="selected"' : ''; ?> >{{$c->CityName}}</option>
                    @endforeach
                  </select>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-xs-9">
                            <textarea id="address" class="form-control required" maxlength="100" name="address"
                                      ...
                                      required rows="4"><?php echo $paymentAccount->address; ?></textarea>
                </div>
              </div>
            ...
            <div class="modal-footer">
              <button class="btn btn-primary" id="payBtn" type="submit"><?php echo __('website.continue');?></button>
            </div>
          </form>
        </div><!-- /.modal-content -->
      </div><!-- /.modal-dialog -->
