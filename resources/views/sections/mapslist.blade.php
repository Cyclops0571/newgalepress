                            ...
                            <div class="form-row">                       
                                <div class="col-md-12">
                                    <div data-device="ipad" data-orientation="portrait" data-color="white" class="device-mockup">
                                      <div class="device">
                                        <div class="screen">
                                            <iframe src="{{ URL::to(__('route.maps_location') . Input::get('applicationID', 0)) }}" scrolling="no" frameborder="0" style="width:100% !important; height:100% !important; overflow:hidden;"></iframe>
                                        </div>
                                      </div>
                                    </div>
                                </div>
