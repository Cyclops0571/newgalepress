<nav id="main-navigation" role="navigation" class="navbar navbar-fixed-top navbar-standard"><a href="javascript:void(0)"
                                                                                               class="search_button"><i
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a href="/{{ Session::get('language') }}" class="navbar-brand"><img src="/images/website/logo-white.png" alt=""
                                                                                class="logo-white"><img
                        src="/images/website/logo-dark.png" alt="" class="logo-dark"></a>
        </div>
        <div class="navbar-collapse collapse">
            ...
            <ul class="nav yamm navbar-nav navbar-left main-nav">
                <li><a href="/{{ Session::get('language') }}/{{__('route.website_why_galepress')}}"
                       title="{{__('website.menu_howitworks')}}" id="menu_item_Home"
                       data-ref="#">{{__('website.menu_howitworks')}}</a></li>

                <li><a href="/{{ Session::get('language') }}/{{__('route.website_sectors')}}"
                       title="{{__('website.menu_solutions')}}" id="menu_item_Pages"
                       data-ref="#">{{__('website.menu_solutions')}}</a></li>

                <li><a href="/{{ Session::get('language') }}/{{__('route.website_showcase')}}"
                       title="{{__('website.menu_showcase')}}" id="menu_item_features-grid"
                       data-ref="features-grid"><?php echo __('website.menu_showcase'); ?></a></li>
