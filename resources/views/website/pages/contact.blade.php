                ...
                <div class="col-md-6 sep-top-xs">
                  <div class="form-group">
                    ...
                    <input id="name" type="text" name="senderName" class="form-control input-lg required"
                           placeholder="{{__('website.contact_form_placeholder_name')}}">
                  </div>
                </div>
                <div class="col-md-6 sep-top-xs">
                  <div class="form-group">
                    <label for="email">E-mail</label>
                    <input id="email" type="email" name="senderEmail" class="form-control input-lg required email"
                           placeholder="{{__('website.contact_form_placeholder_email')}}">
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6 sep-top-xs">
                  <div class="form-group">
                    ...
                    <input id="phone" type="text" name="phone" class="form-control input-lg required"
                           placeholder="{{__('website.contact_form_placeholder_tel')}}">
                  </div>
                </div>
                <div class="col-md-6 sep-top-xs">
                  <div class="form-group">
                    <label for="phone">{{__('website.contact_form_company')}}</label>
                    <input id="company" type="text" name="company" class="form-control input-lg required"
                           placeholder="{{__('website.contact_form_placeholder_company')}}">
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12 sep-top-xs">
                  <div class="form-group">
                    ...
                    <textarea id="comment" rows="9" name="comment" class="form-control input-lg required"
                              placeholder="{{__('website.contact_form_placeholder_message')}}"></textarea>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12 sep-top-xs">
                  <div class="form-group">
                    <button type="submit" class="btn btn-primary"><i
                          class="fa fa-paper-plane"></i>&nbsp;{{__('website.contact_form_submit')}}</button>
                  </div>
                </div>
              </div>
            </form>
