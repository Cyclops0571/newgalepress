...
@section('body-content')
      ...
      <section id="parallax4" style="background-image: url(/images/website/headers/egitim.jpg);" class="header-section parallax">
                ...
                <div class="row">
                  <div data-wow-delay=".5s" class="col-md-10 col-md-offset-1 wow bounceInDown animated" style="visibility: visible; -webkit-animation-delay: 0.5s;">
                    <div class="icon-box icon-horizontal icon-md">
                      <div class="icon-content img-circle"><img src="/images/website/sectors/new/egitim.png" data-wow-delay="1.1s" class="wow fadeInUp"></div>
                    </div>
                  </div>
                </div>
