...
@section('body-content')
      ...
      <section id="parallax4" style="background-image: url(/images/website/headers/gayrimenkul.jpg);" class="header-section parallax">
                ...
                <div class="row">
                  <div data-wow-delay=".5s" class="col-md-10 col-md-offset-1 wow bounceInDown animated" style="visibility: visible; -webkit-animation-delay: 0.5s;">
                    <div class="icon-box icon-horizontal icon-md">
                      <div class="icon-content img-circle"><img src="/images/website/sectors/new/gayrimenkul.png" data-wow-delay="1.3s" class="wow fadeInUp"></div>
                    </div>
                  </div>
                </div>
      ...
      <section class="call-to-action bg-primary sep-top-md sep-bottom-md">
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-3 text-right"><a href="{{route('website_tryit')}}" class="btn btn-light btn-bordered btn-lg">{{__('website.menu_tryit')}}</a></div>
          </div>
        </div>
      </section>
@endsection