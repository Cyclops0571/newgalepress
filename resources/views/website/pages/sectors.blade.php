      ...
      <div class="row">
        <div class="col-md-4">
          <div class="row">
            <div class="col-md-12">
              <div class="team-photo">
                <img src="/images/website/industries/dijital.jpg" class="img-responsive">
                <div class="team-connection">
                  <div class="team-connection-list text-center">
                    <ul>
                      <li>
                        <a href="{{route('website_sectors_digitalpublishing')}}">
                          <img src="/images/website/sectors/new/dijital.png">
                        </a>
                      </li>
                    </ul>
                  </div>
          ...
          <div class="row">
            <div class="col-md-12 sep-top-xs">
              <div class="team-name">
                <a href="{{route('website_sectors_digitalpublishing')}}">
                  <h5>{{__('website.home_sectors_digitalpublishing')}}</h5>
                </a>
              </div>
        ...
        <div class="col-md-4">
          <div class="row">
            <div class="col-md-12">
              <div class="team-photo">
                <img src="/images/website/industries/egitim.jpg" class="img-responsive">
                <div class="team-connection">
                  <div class="team-connection-list text-center">
                    <ul>
                      <li>
                        <a href="{{route('website_sectors_education')}}">
                          <img src="/images/website/sectors/new/egitim.png">
                        </a>
                        </a></li>
                    </ul>
                  </div>
          ...
          <div class="row">
            <div class="col-md-12 sep-top-xs">
              <div class="team-name">
                <a href="{{route('website_sectors_education')}}">
                  <h5>{{__('website.home_sectors_education')}}</h5>
                </a>
              </div>
        ...
        <div class="col-md-4">
          <div class="row">
            <div class="col-md-12">
              <div class="team-photo">
                <img src="/images/website/industries/perakende.jpg" class="img-responsive">
                <div class="team-connection">
                  <div class="team-connection-list text-center">
                    <ul>
                      <li>
                        <a href="{{route('website_sectors_retail')}}">
                          <img src="/images/website/sectors/new/perakende.png">
                        </a>
                        </a></li>
                    </ul>
                  </div>
          ...
          <div class="row">
            <div class="col-md-12 sep-top-xs">
              <div class="team-name">
                <a href="{{route('website_sectors_retail')}}">
                  <h5>{{__('website.home_sectors_retail')}}</h5>
                </a>
              </div>
