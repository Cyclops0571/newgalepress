...
<script src="https://ajax.googleapis.com/ajax/libs/angularjs/1.3.13/angular.min.js"></script>
    ...
    <section id="tryit" class="sep-top-3x sep-bottom-3x" style="background-image: url(/images/website/sectors/backgroundBlur.jpg); background-repeat:no-repeat; background-size:cover;" class="header-section">
      <div class="container">
