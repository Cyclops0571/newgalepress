                    ...
                    <form name="form" ng-submit="submitForm()" ng-controller="FormController" class="tryit-form"
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group text-center"
                                             style="line-height:35px; border-bottom: 1px solid #B5B5B5;">
                                            <script>
                                            ...
                                            <div class="btn-group social-media">
                                                <button type="button" name="glogin" id="glogin"
                                                        class="btn fb-button noTouch"
                                                        style="width:60px; height:42px; padding:0;"><i
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="last_name" name="last_name"
                                                   ...
                                                   ng-class="{'ng-invalid ng-invalid-required formError' : errorLastName}"
                                                   required class="form-control input-sm"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="app_name" name="app_name" ng-model="formData.app_name"
                                           ng-class="{'ng-invalid ng-invalid-required formError' : errorAppName}"
                                           required class="form-control input-sm"
                                           placeholder="{{__('website.tryit_form_appname_placeholder')}}">
                                ...
                                <div class="row">
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="captchainput form-control input-sm"
                                                   placeholder="{{__('website.tryit_form_securitycode_placeholder')}}"
                                                   id="captcha" name="captcha" ng-model="formData.captcha"
                                                   ng-class="{'ng-invalid ng-invalid-required formError' : errorCaptcha}"
                                                   required type="text">
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group" onclick="changeCaptcha()" style="cursor:pointer">
                                            <input class="captchaimg noTouch" src="{{MeCaptcha\Captcha::img()}}"
                                                   name="captcha" id="captcha" type="image" style="margin-top:26.05px;">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel-footing" style="display:-webkit-box !important; height:80px;">
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <a href="/{{ Session::get('language') }}/{{__('route.login')}}"
