            ...
            <div class="row">
                ...
                <div class="col-md-8 col-xs-12 intAnimeFrame">
                    ...
                    <div class="col-md-1 col-xs-1 compRightCol" style="margin-left:-50px;">
                        ...
                        <img src="/images/website/icons/light/new/scroller.png" class="compenents"
                        ...
                        <img src="/images/website/icons/light/new/bookmark.png" class="compenents"
                             style="margin-top:21px;">
                        <img src="/images/website/icons/light/new/animasyon.png" class="compenents"
                             style="margin-top:21px;">
                    </div>
                </div>
            </div>
            ...
            <div class="row" style="text-align:left;">
                <div class="col-md-5 col-md-offset-1 col-sm-6">
                    <div data-wow-delay="1s"
                        ...
                        <div class="icon-content img-circle transparent"><img src="/images/website/icons/video.png"/></div>
                    ...
                    <div data-wow-delay="1s"
                         class="icon-box icon-lg sep-top-md sep-top-sm icon-gradient wow bounceInRight animated"
                         style="visibility: visible; -webkit-animation-delay: 1s;">
                        <div class="icon-content img-circle transparent"><img src="/images/website/icons/ses.png"/></div>
                        <div class="icon-box-content">
                    ...
                    <div data-wow-delay="1s"
                         class="icon-box icon-lg sep-top-md sep-top-sm icon-gradient wow bounceInRight animated"
                         style="visibility: visible; -webkit-animation-delay: 1s;">
                        <div class="icon-content img-circle transparent"><img src="/images/website/icons/harita.png"/>
                        </div>
                        <div class="icon-box-content">
                    ...
                    <div data-wow-delay="1s"
                         class="icon-box icon-lg sep-top-md sep-top-sm icon-gradient wow bounceInRight animated"
                         style="visibility: visible; -webkit-animation-delay: 1s;">
                        <div class="icon-content img-circle transparent"><img src="/images/website/icons/link.png"/></div>
                        <div class="icon-box-content">
                    ...
                    <div data-wow-delay="1s"
                         class="icon-box icon-lg sep-top-md sep-top-sm icon-gradient wow bounceInRight animated"
                         style="visibility: visible; -webkit-animation-delay: 1s;">
                        <div class="icon-content img-circle transparent"><img src="/images/website/icons/web.png"/></div>
                        <div class="icon-box-content">
                ...
                <div class="col-md-6 col-sm-6">
                    <div data-wow-delay="1s"
                         class="icon-box icon-lg sep-top-md sep-top-sm icon-gradient wow bounceInRight animated"
                         style="visibility: visible; -webkit-animation-delay: 1s;">
                        <div class="icon-content img-circle transparent"><img src="/images/website/icons/tooltip.png"/>
                        </div>
                        <div class="icon-box-content">
                    ...
                    <div data-wow-delay="1s"
                         class="icon-box icon-lg sep-top-md sep-top-sm icon-gradient wow bounceInRight animated"
                         style="visibility: visible; -webkit-animation-delay: 1s;">
                        <div class="icon-content img-circle transparent"><img src="/images/website/icons/scroller.png"/>
                        </div>
                        <div class="icon-box-content">
                    ...
                    <div data-wow-delay="1s"
                         class="icon-box icon-lg sep-top-md sep-top-sm icon-gradient wow bounceInRight animated"
                         style="visibility: visible; -webkit-animation-delay: 1s;">
                        <div class="icon-content img-circle transparent"><img src="/images/website/icons/slider.png"/>
                        </div>
                        <div class="icon-box-content">
                    ...
                    <div data-wow-delay="1s"
                         class="icon-box icon-lg sep-top-md sep-top-sm icon-gradient wow bounceInRight animated"
                         style="visibility: visible; -webkit-animation-delay: 1s;">
                        <div class="icon-content img-circle transparent"><img src="/images/website/icons/360.png"/></div>
                        <div class="icon-box-content">
                    ...
                    <div data-wow-delay="1s"
                         class="icon-box icon-lg sep-top-md sep-top-sm icon-gradient wow bounceInRight animated"
                         style="visibility: visible; -webkit-animation-delay: 1s;">
                        <div class="icon-content img-circle transparent"><img src="/images/website/icons/bookmark.png"/>
                        </div>
                        <div class="icon-box-content">
